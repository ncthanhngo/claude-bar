...
var AllTools = []ToolMeta{
	...
	{ID: "cb_gdrive_share", Service: domain.MCPServiceGDrive, Label: "Share file", Description: "Grant a specific user reader / commenter / writer access. Gated.", Category: "Writes", Priority: ToolPriorityAdvanced},
