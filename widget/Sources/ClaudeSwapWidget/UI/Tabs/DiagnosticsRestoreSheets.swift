...
// Passphrase entry sheet — shared by "Enable sync / Push update" (push intent)
// and "Restore" (pull intent). On pull, opens the preview-table sheet instead
// of restoring directly so the user can compare CreatedAt and pick accounts.
struct PassphraseSheet: View {
    @EnvironmentObject var cloudSync: CloudSyncCoordinator

    @Binding var passphraseField: String
    @Binding var passphraseError: String?
    @Binding var showPassphraseEntry: Bool
